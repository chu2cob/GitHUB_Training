---
description: Apply these instructions when writing, reviewing, or modifying Playwright end-to-end tests or test-related TypeScript/JavaScript files.
applyTo: '**/*.spec.ts,**/*.test.ts,**/playwright.config.ts,**/tests/**/*.ts'
---
